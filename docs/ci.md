...
测例与评测器放在同一个 [GitHub 仓库](https://github.com/thu-db/dbs-testcase) `dbs-testcase` 中，清华同学可以用[清华 Git 仓库](https://git.tsinghua.edu.cn/dbs/2023/public/dbs-testcase)以更快地访问，两边内容是一致的。
